...
test_x_path = "~/Projects/ehr_deeplearning/data/full_data10000_indexes_180days.test_x.aggregated.tsv"
test_y_path = "~/Projects/ehr_deeplearning/data/full_data10000_indexes_180days.test_y.aggregated.tsv"

train_x_path = "~/Projects/ehr_deeplearning/data/full_data10000_indexes_180days.train_x.aggregated.tsv"
train_y_path = "~/Projects/ehr_deeplearning/data/full_data10000_indexes_180days.train_y.aggregated.tsv"
...
test_x = pd.read_csv(test_x_path, sep='\t').values
test_y = pd.read_csv(test_y_path, sep='\t').values.flatten()

train_x = pd.read_csv(train_x_path, sep='\t').values
train_y = pd.read_csv(train_y_path, sep='\t').values.flatten()
...
hidden_layers = [[10, 10],[50, 5],[10, 10, 10],[50, 10, 10],[50,10,5],[10, 10, 5]]
                #[10,10,10,10],[50,25,10,5],[10,10,10,10,10],[50,25,10,10,5]]
